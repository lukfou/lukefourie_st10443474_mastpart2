...
export default function AddMenuScreen({ navigation }: AddMenuScreenProps) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.label}>Dish Name: Tirimasu:</Text>
      <TextInput style={styles.input} onChangeText={setDishName} value={dishName} />

      <Text style={styles.label}>Description: Classic Italian dessert made with layers of coffee-soaked lady fingers, mascarpone cheese and a dusting of cocoa powder:</Text>
      <TextInput style={styles.input} onChangeText={setDescription} value={description} />

      <Text style={styles.label}>Course: Dessert</Text>
      ...
      <Text style={styles.label}>Price: R120</Text>
      <TextInput
        style={styles.input}
